...
1. **(2019) Studying software engineering patterns for designing machine learning systems.**  This paper reports the preliminary results of a systematic-literature review (SLR) of good/bad design patterns for ML to provide developers with a comprehensive classification of such patterns. [Go to paper](https://ieeexplore.ieee.org/document/8945075).
