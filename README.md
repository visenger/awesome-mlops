...
1. **(2019) Continuous integration of machine learning models with ease.ml/ci: towards a rigorous yet practical treatment.** This paper presents ease.ml/ci, to the authors best knowledge, the first continuous integration system for machine learning to provide rigorous guarantees with a practical amount of labeling effort. [Go to paper](https://arxiv.org/abs/1903.00278)
